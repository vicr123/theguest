...
class QSpiceWidget : public QWidget {
    ...
    public:
         ...
         */
        bool connectToSpiceSource(const QUrl& uri, const QString& passwd);

        bool connectToSpiceSource(const QString& unixPath, const QString& passwd);
         ...
         */
        Q_DECL_DEPRECATED void sendKeySequience(Qt::Key); //Kept for backward compat.
        void sendKeySequence(Qt::Key);
